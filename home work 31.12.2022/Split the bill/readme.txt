...
Конструктор класса Bill создает переменную экземпляра с именем amounts, которая представляет собой пустой массив. Дополните класс Bill следующими методами экземпляра:
